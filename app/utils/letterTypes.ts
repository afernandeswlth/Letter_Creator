...
export const LETTER_TYPES: Record<LetterTypeId, LetterType> = {
  ...
  'credit-approval-memorandum': {
    ...
    fields: [
      ...
      { id: 'security', label: 'Security', type: 'richtext', required: false, rows: 6, default: 'Metro (Category 1)\nValuation Date:\nMain Dwelling:\nLiving Area:\nComparable Sales:\nMarket Value (Valuation Report):\nRental Income:', section: 'Background Information' },
      { id: 'lmi', label: 'LMI', type: 'text', required: false, default: 'N/A (Does not exceed 80% LVR)', section: 'Background Information' },
      { id: 'refinanceNotes', label: 'Refinance History', type: 'table', required: false, flat: true, showHeader: false, rowLabelPrefix: 'Refinance', maxRows: 5, columns: [{ label: 'Notes', placeholder: 'e.g. Firstmac — $258,500.00' }], help: 'Add up to 5 refinances — each becomes a row (Refinance N | notes).', section: 'Background Information' },
      { id: 'refinanceHistoryNotes', label: 'Notes', type: 'textarea', required: false, rows: 2, placeholder: 'Optional notes about the refinance history…', section: 'Background Information' },
      { id: 'liabilities', label: 'Liabilities', type: 'table', required: false, columns: [{ label: 'Type of Loan', placeholder: 'Home loan (WLTH)' }, { label: 'Outstanding Balance / Limit', placeholder: '$450,000 / $460,000' }, { label: 'Conduct', placeholder: 'Satisfactory' }], help: 'One row per liability — add as many as needed.', section: 'Background Information' },
      { id: 'liabilitiesNotes', label: 'Notes', type: 'textarea', required: false, rows: 2, placeholder: 'Optional notes about the liabilities…', section: 'Background Information' },
      { id: 'creditHistory', label: 'Credit History', type: 'richtext', required: false, rows: 5, default: 'Report date:  – Comprehensive\nEquifax Score:\nClear from any adverse\nNo Recent Credit Enquiries\nNo Recent Commercial Enquiry\nNo Current Directorship', section: 'Background Information' },
      { id: 'ndi', label: 'NDI', type: 'textarea', required: false, rows: 2, section: 'Background Information' },
      { id: 'livingCost', label: 'Living Cost', type: 'richtext', required: false, rows: 2, placeholder: 'Living cost: $ pm / $ pa — HEM of ( %)', section: 'Background Information' },
      // Assessment
      { id: 'policyExceptions', label: 'Policy Exceptions (including mitigants)', type: 'richtext', required: false, rows: 3, section: 'Assessment' },
      { id: 'finalAssessment', label: 'Final Assessment', type: 'richtext', required: false, rows: 8, default: 'I have assessed the loan application in a prudent manner and reasonable enquiries have been made in my assessment and I have determined that the loan is not unsuitable for the applicant/s and that the:\nthe loan terms meet the applicant/s requirements and objectives;\nthe applicant/s will be able to comply with their financial obligations under the loan product;\nthe applicant/s have the requisite capacity to service all financial commitments and without substantial hardship; and\neach applicant/s has the requisite authority / capacity to grant the supporting securities.', section: 'Assessment' },
