...
/**
 * WLTH icon set — Lucide, matching the WLTH design system
 * (https://wlth-design-system-delta.vercel.app/components/icons, `i-lucide-*`).
 * Icon bodies are the exact Lucide 24×24 outline SVGs. Add names here as needed.
 * Usage: <WIcon name="shield" class="h-6 w-6" />
 */
...
const ICONS: Record<string, string> = {
  ...
  download: '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 15V3m0 12l-4-4m4 4l4-4"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></g>',
}
</script>

<template>
  <!-- eslint-disable-next-line vue/no-v-html -->
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-html="ICONS[name] || ''" />
</template>
